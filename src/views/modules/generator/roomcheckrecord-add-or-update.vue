    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          operationId: [
            { required: true, message: '查房人id不能为空', trigger: 'blur' }
          ],
          content: [
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.operationId = data.roomCheckRecord.operationId
                this.dataForm.content = data.roomCheckRecord.content
                this.dataForm.createTime = data.roomCheckRecord.createTime
              }
            })
          }
        })
